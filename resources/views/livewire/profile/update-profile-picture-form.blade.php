    ...
    public function changeProfile()
    {
        try {
            $validated = $this->validate(
                ['profilepicture' => ['image','max:10240']], //10 mb max;
            );
        ...
        <div class="flex flex-row lg:flex-row p-5 w-auto">
            ...
            <div class="flex-row items-center justify-center p-20 ">
                <div class="mb-8 text-white">
                    <input name="profilepicture" accept="image/png, image/jpeg, image/jpg" type="file" wire:model='profilepicture' id="profilepicture">
                </div>
                <div wire:loading wire:target="profilepicture" class="text-green-600">Uploading...</div>
