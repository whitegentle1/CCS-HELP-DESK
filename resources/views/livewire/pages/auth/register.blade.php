                        ...
                        if (!str_ends_with($value, '@dhvsu.edu.ph')) {
                            $fail(
                                'The ' .
                                    $attribute .
                                    ' must
be a valid @dhvsu.edu.ph email address.',
                            );
                        }
                    },
                ],
                'password' => ['required', 'min:8', 'confirmed', 'regex:/^(?=.*[A-Z])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]+$/'],
            ],
            [
...
<x-popup name="Register">
    <div class="flex w-full flex-wrap content-center justify-center">
        ...
        <div class="flex shadow-md">
            <!-- Register banner -->
            <div class="flex flex-wrap content-center justify-center rounded-l-md" style="width: 24rem">
                <img class="h-full w-full rounded-l-md bg-cover bg-center bg-no-repeat"
                    src="{{ asset('assets/imgs/reg-dark.png') }}" />
            </div>
            <!-- Register form -->
            <div class="flex flex-wrap content-center justify-center rounded-r-md bg-white p-5 dark:bg-gray-700"
                style="width: 24rem">
                <div class="w-72">
                    <!-- Heading -->
                    <h1 class="text-right text-xl font-semibold dark:text-gray-800">
                    ...
                    <form wire:submit="register" class="mt-4">
                        ...
                        <div class="mb-3">
                            <select wire:model="course" name="course"
                        ...
                        <div class="mb-3">
                            <input wire:model="firstname" name="firstname" type="text"
                                placeholder="Enter your first name"
                                class="block w-full rounded-md border border-gray-300 px-1.5 py-1 text-right text-sm text-gray-500 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-800" />
                        </div>
                        <div class="mb-3">
                            <input wire:model="middlename" name="middlename" type="text"
                                placeholder="Enter your middle name(optional)"
                                class="block w-full rounded-md border border-gray-300 px-1.5 py-1 text-right text-sm text-gray-500 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-800" />
                        </div>
                        <x-input-error :messages="$errors->get('lastname')" class="mt-2" />
                        <div class="mb-3">
                            <input wire:model="lastname" name="lastname" type="text"
                                placeholder="Enter your last name"
                                class="block w-full rounded-md border border-gray-300 px-1.5 py-1 text-right text-sm text-gray-500 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-800" />
                        </div>
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                        <div class="mb-3">
                            <input wire:model="email" name="email" type="email" placeholder="Enter your DVHSU email"
                                class="block w-full rounded-md border border-gray-300 px-1.5 py-1 text-right text-sm text-gray-500 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-800" />
                        </div>
                        ...
                        <div class="mb-3">
                            <x-primary-button wire:target="register"
                                ...
                                <span wire:loading>
                                    <svg width="20px" height="20px" viewBox="0 0 16 16"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" class="animate-spin"
                ...
                <div class="mb-3 flex flex-wrap content-center">
                    <!-- Remember Me -->
                    <input id="termsandprivacy" type="checkbox" class="mr-1 checked:bg-gray-700" />
                    <label for="remember" class="mr-auto text-xs font-semibold dark:text-gray-900">
                        {!! __(
                            'I agree to the :terms_of_service and
                                                :privacy_policy',
                            [
                                'terms_of_service' =>
                                    '<a
                ...
                <div class="text-center">
                    <span class="text-xs font-semibold text-gray-400">Already have an account?</span>
                    <a x-data @click="$dispatch('open-modal',{name:'Login'})"
