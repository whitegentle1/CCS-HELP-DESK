...
<div class="antialiased sans-serif h-screen">
	<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
		<div class="container mx-auto px-4 py-2 md:py-24">
			...
			<div class=" bg-slate-300 rounded-lg shadow overflow-hidden">
				...
				<div class="flex items-center justify-between py-2 px-6">
					...
					<div class="border rounded-lg px-1" style="padding-top: 2px;">
						<button
							...
							<svg class="h-6 w-6 text-slate-950 inline-flex leading-none"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
